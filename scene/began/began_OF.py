...
parser.add_argument("--save_dir", type=str, default="../../exp/OF_began1", help="interval between image sampling")
...
for epoch in range(opt.n_epochs):
    for i, (imgs, _) in enumerate(dataloader):
        ...
        if batches_done % opt.sample_interval == 0:
            save_image(gen_imgs.data[:25], f"{opt.save_dir}/images/%d.png" % batches_done, nrow=5, normalize=True)
